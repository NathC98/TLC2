...
def listeIdent(lexical_analyser):
	...
	codeGenerator.append("empiler("+str(ident)+");\n");
...
def instr(lexical_analyser):
	if lexical_analyser.isKeyword("while"):
		...
		if lexical_analyser.isSymbol(":="):
			...
			codeGenerator.append("empiler(ad(ident));\n");
			...
			codeGenerator.append("traStat(ad(f ou p), n le nombre de parametres;\n");
...
def listePe(lexical_analyser):
	...
	codeGenerator.append("empilerAd(as(X));\n");
